...
def MC(N, z):
	'''
	*N*
		int - index of row from Master_data.csv to start iterate from
	*z*
	...
	for n in range(N-1, len(data_paths)):
		...
		if source[n,2] == "err":
			name = names[n]
			print "Object: {0}, data index {1}".format(name, true_N)
			data = data_paths[n]
			spectrum = np.genfromtxt(data, dtype = float)
		...
		if not os.path.exists('/Users/saracamnasio/Dropbox/Research/Projects/UnusuallyRB/2016_Analysis/New_fits_June16/{0}_{1}'.format(true_N, name)):
			os.makedirs('/Users/saracamnasio/Dropbox/Research/Projects/UnusuallyRB/2016_Analysis/New_fits_June16/{0}_{1}'.format(true_N, name))
		plt.savefig('/Users/saracamnasio/Dropbox/Research/Projects/UnusuallyRB/2016_Analysis/New_fits_June16/{0}_{1}/{1}_plot.png'.format(true_N, name), format='png')
		plt.savefig('/Users/saracamnasio/Dropbox/Research/Projects/UnusuallyRB/2016_Analysis/New_fits_June16/{0}_{1}/{1}_plot.pdf'.format(true_N, name), format='pdf')
		plt.close()
		...
		plt.ylabel('Probability')
		plt.xlabel('IP value')
		plt.savefig('/Users/saracamnasio/Dropbox/Research/Projects/UnusuallyRB/2016_Analysis/New_fits_June16/{0}_{1}/{1}_hist_IP.png'.format(true_N, name), format='png')
		# plt.close()
		...
		plt.savefig('/Users/saracamnasio/Dropbox/Research/Projects/UnusuallyRB/2016_Analysis/New_fits_June16/{0}_{1}/{1}_hist_lmax.png'.format(true_N, name), format='png')
		# plt.close()
		...
		plt.savefig('/Users/saracamnasio/Dropbox/Research/Projects/UnusuallyRB/2016_Analysis/New_fits_June16/{0}_{1}/{1}_hist_lmin.png'.format(true_N, name), format='png')
		# plt.close()
...
# 
		...
		np.savetxt('/Users/saracamnasio/Dropbox/Research/Projects/UnusuallyRB/2016_Analysis/New_fits_June16/{0}_{1}/{1}_unc_arrays.txt'.format(true_N, name), output_arrays)

		results_row = [true_N, name, mu0, sigma0, mu1, sigma1, mu2, sigma2, mu3, sigma3, mu4, sigma4, mu5, sigma5, mu6, sigma6, mu7, sigma7]

		with open("/Users/saracamnasio/Dropbox/Research/Projects/UnusuallyRB/2016_Analysis/output/Results.csv", "a") as fp:
